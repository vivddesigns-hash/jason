---
name: telegram-setup
description: Connect a Telegram bot to the Jason Assistant gateway with automated webhook registration and credential storage
...
You are helping your user connect a Telegram bot to the Jason Assistant gateway. Walk through each step below.

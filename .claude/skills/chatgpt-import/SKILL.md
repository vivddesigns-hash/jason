---
name: chatgpt-import
description: Import conversation history from ChatGPT into Jason
...
Import ChatGPT conversation history into Jason so users can keep their conversation context and memory when switching from ChatGPT.
